...
def generate_launch_description():
    ...
    world_file = os.path.join(mvsim_dir, 'mvsim_tutorial', 'greenhouse_control.world.xml')
    mvsim_params = os.path.join(mvsim_dir, 'mvsim_tutorial', 'mvsim_ros2_params.yaml')
    slam_params = os.path.join(mvsim_nav2_demo_dir, 'params', 'nav2_slam_greenhouse.yaml')

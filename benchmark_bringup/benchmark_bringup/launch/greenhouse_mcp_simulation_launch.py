...
MVSIM_ROS2_PARAMS_FILE = os.path.join(mvsimDir, 'mvsim_tutorial', 'greenhouse_nav2_params.yaml')
...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(mvsimNav2DemoDir, 'params', 'greenhouse_nav2_params.yaml'),

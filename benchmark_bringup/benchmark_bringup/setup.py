...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/definitions/sensors', glob('definitions/sensors/*')),
    ...
    entry_points={
        'console_scripts': [
            ...
            'plotter_c1 = benchmark_bringup.plotter.plotter_c1:main',
            'plotter_c2 = benchmark_bringup.plotter.plotter_c2:main',
            'plotter_c3 = benchmark_bringup.plotter.plotter_c3:main',
